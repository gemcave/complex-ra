    ...
    switch (action.type) {
      ...
      case 'usernameUniqueResults':
        if (action.value) {
          ...
          draft.username.hasErrors = 'The username is already taken.';
        } else {
      ...
      case 'emailUniqueResults':
        if (action.value) {
          ...
          draft.email.message = 'That email is alredy being used.';
        } else {
      ...
      case 'passwordImmediately':
        ...
        if (draft.password.value.length > 50) {
          ...
          draft.password.message =
            'Password cannot cannot exceed 50 characters.';
        }
        return;
